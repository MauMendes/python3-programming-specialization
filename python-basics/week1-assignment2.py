...
#B. Return values.
#C. Create new attributes of an instance and set their value
...
#turtle-11-7: What are the names of the instances in the following code? Please put one instance per blank space and enter them in the order that the 
