...
# Store the result in the variable same_letter_count. Hard-coded answers will receive no credit.
...
#HINT 1: Use the accumulation pattern! HINT 2: the in operator checks whether a substring is present in a string. Hard-coded answers will receive no credit.
...
#Note 1: be sure to not double-count words that contain both an a and an e. HINT 1: Use the in operator.
#HINT 2: You can either use or or elif. Hard-coded answers will receive no credit.
...
#5) Write code that will count the number of vowels in the sentence s and assign the result to the variable num_vowels. For this problem, 
